                            ...
                            <div className="card-body ">
                                <div className="row">
                                    ...
                                    <div className="col-sm-4">
                                        ...
                                        <span className="fs-6 text"><a href={info.trackViewUrl} className="link-danger" target="_new">View Track</a></span>
                                    </div>
                                    <div className="col-sm-3 text-right">
                                    <img className="img-thumb-nail"  src={info.artworkUrl100} alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
